...
#PBS -N Social_Doors_Kids-fmriprep
#PBS -q normal
...
for subj in ${subjects}; do
    echo singularity run --cleanenv \
            -B ~/work/templateflow:/opt/templateflow \
            ~/fmriprep-22.0.2.simg \
            /home/tuk12127/work/social_doors_kids /home/tuk12127/work/social_doors_kids/derivatives/fmriprep \
            participant \
