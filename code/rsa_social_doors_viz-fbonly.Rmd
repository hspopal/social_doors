...
```{r}
roi_plot_order <- c('TPJ_b-social', 'dmPFC_b-social', 'striatum_ventral',
                    'region06', 'region08','region02')

roi_plot_label <- c('TPJ', 'dmPFC', 'Ventral Striatum',
                    'CB Region 6', 'CB Region 8','CB Region 2')
```
...
p + theme(axis.text.x = element_text(angle =45, vjust = 0.5)) + 
  geom_signif(comparisons = list(c('region06', 'dmPFC_b-social'),
                                 c('region06', 'striatum_ventral'),
                                 c('region08', 'striatum_ventral')),
              map_signif_level = TRUE,
              annotations = c('**','***','**'), y_position = c(0.1,0.08,0.12),
                            tip_length = 0,
                            vjust=0.1) + 
...
p <- ggbarplot(all_sim_vcr_social_rois, x = 'roi', 
               ...
               position = position_dodge(0.8))
p + theme(axis.text.x = element_text(angle =45, vjust = 0.5)) + 
  geom_signif(comparisons = list(c('region06','TPJ_b-social'),
                                 c('region06','region02'),
                                 c('region06','striatum_ventral'),
              ...
              map_signif_level = TRUE,
              annotations = c('**','**','***','*','*','**'), 
              y_position = c(0.16,0.14,0.125,0.245,.2,.22), tip_length = 0) + 
  scale_x_discrete(labels=roi_plot_label) + 
  xlab("Regions of Interests") + ylab("Spearman's rho") + 
