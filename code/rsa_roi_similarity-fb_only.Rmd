...
roi_roi_sim <- rbind(roi_sim_region06, 
                     roi_sim_region08,
                     roi_sim_region02,
                     roi_sim_striatum)
```
...
## One-Sample T-Tests
```{r}
roi_roi_sim_cb6 <- roi_roi_sim_roi[(roi_roi_sim_roi$target == 'region06'), ]
...
```{r}
all_sim_cb6_rois.ttests <- conduct_ttests(roi_roi_sim_cb6, 'region06')
...
target_rois <- c('region02','region06','region08','ventral_striatum')
target_rois_stats <- list(all_sim_cb2_rois.ttests, all_sim_cb6_rois.ttests,
                          all_sim_cb8_rois.ttests, all_sim_str_rois.ttests)
